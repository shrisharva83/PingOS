...
{
	Nokia5110_SetCursor(0,0);
	Nokia5110_DrawFullImage(custom);
		
}

void Nokia5110_paddleA(int x)
{
		Nokia5110_SetCursor(x%9,0);
		for(int i=0;i<paddle_length;i++)
				lcdwrite(DATA, 0xFF);
}
void Nokia5110_paddleA_clear(int x)
{
...
void Nokia5110_paddleB(int x)
{
		Nokia5110_SetCursor(x%9,5);
		for(int i=0;i<paddle_length;i++)
				lcdwrite(DATA, 0xFF);
}

void Nokia5110_paddleB_clear(int x)
{
...
void Nokia5110_Ball(int x, int y)
{
	//Nokia5110_Clear();
	Nokia5110_SetCursor(x%12,y%6);
	for(int i=0;i<6;i++)
			lcdwrite(DATA, 0xFF);
} 


void Nokia5110_Ball_clear(int x, int y)
{
	//Nokia5110_Clear();
	Nokia5110_SetCursor(x%12,y%6);
	for(int i=0;i<6;i++)
...
void Nokia5110_Score(int a, int b)
{
	Nokia5110_SetCursor(4,2);
	Nokia5110_OutChar('A');
	Nokia5110_OutChar(':');
	Nokia5110_OutChar((char)(a));
	Nokia5110_SetCursor(4,3);
	Nokia5110_OutChar('B');
	Nokia5110_OutChar(':');
	Nokia5110_OutChar((char)(b));
